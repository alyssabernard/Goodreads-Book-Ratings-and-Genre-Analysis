...
- **book_tags.csv:** relationship between books and tags
...
- Creating clean views for each table (books_clean, ratings_clean, tags_clean, book_tags_clean)

- Standardizing text fields by using TRIM() and LOWER()

- Handling data type inconsistencies by utilizing SAFE_CAST
